...
//Ejercicios con if
		// Determina si un número es positivo. Declara un número y usa if para verificar
		// si es mayor que 0.
		int num = 11;
		if (num > 0) {
...
//Ejercicios con if-else
		...
		// Verifica si una letra es vocal o consonante (para simplificar, considera solo
		...
		// Determina si un año es bisiesto. (Pista: un año es bisiesto si es divisible
...
//Ejercicios con if-else if-else
		...
		// Calcula el precio de una entrada al cine según la edad: niño (5€), adulto
		// (10€), anciano (7€).
		if (edad <= 2 && edad <= 12) {
		...
		// Asigna una nota en función de la calificación: A (>=90), B (>=80), C (>=70),
		// D (>=60), F (<60).
		int nota = 80;
		if (nota >= 90) {
		...
		// Evalúa un número si es negativo, positivo, o cero, mostrando un mensaje en
		// cada caso.
		if (num > 0) {
			System.out.println("El numero ingresado es positivo");
		} else if (num < 0) {
		...
		// Determina el nivel de peligro de un volcán según su estado (dormido, activo,
		// erupción inminente).
...
//Ejercicios con switch
		...
		System.out
				.println("El día de la semana correspondiente al número " + numeroDeDia + " es el dia " + nombreDeDia);
		...
		// Determina el nombre de una estación del año según un número (1: invierno, 2:
		// primavera, 3: verano, 4: otoño).
		...
		// Calcula operaciones aritméticas básicas (suma, resta, multiplicación,
		// división) según un operador ingresado (+, -, *, /).
		float numA = 4.0f;
		float numB = 0.0f;
		...
		// Verifica el tipo de fruta según su código: 1: manzana, 2: plátano, 3:
		// naranja, 4: uva.
		int numFruta = 3;
		String fruta;
...
//Ejercicios con Operadores Ternarios
		...
		// Asigna el valor "Positivo" o "Negativo" a una variable según el valor de un
		// número.
		boolean valor = num >= 0;
		...
		// Asigna un valor "Aprobado" o "Reprobado" a una variable en función de una
		// nota.
		String calificacion = (nota >= 4) ? "Aprobado" : "No aprobado";
		System.out.println("El alumno está " + calificacion);

//Ejercicios con Math.random()
		// Genera un número aleatorio entre 1 y 10 y muestra un mensaje si es mayor que
		// 5.
		int minimo = 1;
		int maximo = 10;
		...
		randon = (int) (Math.random() * rango)
				+ minimo; /** rango para que respete el rango y sumo minimo para que arranque de ahi */
		...
		int entre = max - min + 1;
		int dado = 0;
		dado = (int) (Math.random() * entre)
				+ minimo; /** rango para que respete el rango y sumo minimo para que arranque de ahi */
		System.out.println("El numero de dado es: " + dado);

		// Genera un número aleatorio entre 0 y 100 y determina si es mayor, menor o
		// igual a 50.
		int mini = 1;
		int maxi = 100;
...
//Ejercicios combinando condicionales
		// Determina si un número es positivo, negativo o cero usando un operador
		// ternario.
		String resultado5 = (num > 0) ? "positivo" : (num < 0) ? "negativo" : "igual a 0";
		System.out.println("El numero es " + resultado5);

		// Simula un semáforo. Muestra el estado (verde, amarillo, rojo) según un número
		...
		// Crea un programa que simule una lotería. Genera un número aleatorio y
		// verifica si es igual a un número predeterminado.
		...
		// Genera un número aleatorio entre 1 y 100 y evalúa si es divisible por 3 o por
		// 5.
		String divisible = (random % 3 == 0) ? " es divisible por 3"
				: (random % 5 == 0) ? " es divisible por 5" : " No es divisible ni por 3 ni por 5";
		...
		// Genera un número aleatorio entre 1 y 100 y clasifícalo en categorías: bajo
		// (<30), medio (>=30 y <=70), alto (>70).
		if (random < 30) {
		...
		// Simula una adivinanza de un número entre 1 y 10. El usuario ingresa un número
		// y el programa le dice si acertó o no.
		int numAdivinar = 4;
		...
		// Genera un número aleatorio entre 1 y 50 y verifica si está en el rango de
		// [20, 30].
		int otroNum = (int) (Math.random() * 50) + 1;
		String resultado7 = (otroNum > 20 && otroNum < 30) ? " está dentro del rango"
				: " no está dentro del rango (20-30)";
		System.out.println("El numero " + otroNum + resultado7);

//Ejercicios avanzados básicos
		// Simula un lanzamiento de tres dados y verifica si la suma de los resultados
		// es mayor que 10.
		...
		// Simula una ruleta de colores: genera un número aleatorio del 1 al 5 y asigna
		// un color.
		...
		// Calcula el descuento en una tienda dependiendo del tipo de cliente: 1. Normal
		// (sin descuento), 2. Miembro (10% de descuento), 3. VIP (20% de descuento).
		...
		// Evalúa el clima: genera un número aleatorio y asigna un estado del tiempo
		...
		// Determina el ganador de un juego de piedra, papel o tijera usando números
		// aleatorios y switch.
		...
		// Simula un juego de adivinanza: el usuario tiene que adivinar un número entre
		// 1 y 5 generado aleatoriamente.
		int numJugador = 1;
		System.out.println("Adivinanza | Elegiste el número " + numJugador);

		int numeJuego = (int) (Math.random() * 5) + 1;
		System.out.println("La máquina eligió el número " + numeJuego);

		if (numJugador == numeJuego) {
			System.out.println("Ganaste");
		} else {
			System.out.println("Perdiste");
		}

		// Crea un programa que asigne una beca: si la nota es >= 85 y la edad < 25, el
		// estudiante recibe una beca.
		if (nota >= 90 && edad < 25) {
			System.out.println("El estudiante recibe una beca");
		} else {
			System.out.println("No puede aplicar a la beca");
		}
		// Determina si un número generado aleatoriamente entre 1 y 100 es un número
		// perfecto
		/* (la suma de sus divisores propios es igual al número). */
		/*
		 * uso de vuelta random: int random = (int) (Math.random()*100) + 1;
		 * System.out.println("El número generado es: " + random);
		 * 
		 * determino cuándo un numero es perfecto boolean esNumPerfecto(int random) {
		 * int sumaDivisores = 0; for (int esNumPerfecto = 1; esNumPerfecto < random;
		 * esNumPerfecto++) { if (random % i == 0) { sumaDivisores += i; } } if
		 * (sumaDivisores == random); { System.out.println("El número es perfecto");
		 */
		/*-------------------------------NI IDEA ESTE EJERCICIO CHE-------------------------------------*/
		...
		String comparacion = (num1 > num2) ? ("El numero " + num1 + " es mayor") : ("El numero " + num2 + " es mayor");
	
		System.out.println(comparacion);
		
/*-----------------------------QUE PONGO PARA QUE NO SALGAN 2 NUMEROS IGUALES?-------------------------------*/
 
		// Genera un número aleatorio entre 1 y 100 y evalúa si es mayor que 75 usando un operador ternario.
		/*uso int num1 de vuelta*/
		System.out.println("El " + num1 + " es mayor que 75?");
		String esMayor = (num1 > 75) ? "Si" : "No";
		System.out.println(esMayor);
		
		// Simula un juego de dados: si la suma de dos dados es 7 o 11, el jugador gana.
		/*uso los dados que ya tenía*/
		System.out.println("Dado1: " + dado1);
		System.out.println("Dado2: " + dado2);
		int sumaDeDados = dado1 + dado2;
		if (sumaDeDados == 7) {
			System.out.println("La suma de los dados es igual a 7. El jugador gana");
		} else if (sumaDeDados == 11) {
			System.out.println("La suma de los dados es igual a 11. El jugador gana");
		} else {
